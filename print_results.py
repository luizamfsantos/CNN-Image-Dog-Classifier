...
def print_results(results_dic, results_stats_dic, model,
	...
	print(f"\n\n*** Results Breakdown for {model.upper()} CNN Model Performance ***\n\n"
      f"Number of Images: {results_stats_dic['n_images']}\n"
      f"Number of Dog Images: {results_stats_dic['n_dogs_img']}\n"
      f"Number of \"Not-a\" Dog Images: {results_stats_dic['n_notdogs_img']}\n"
      f"Percentage of Correctly Classified Dog Images: {results_stats_dic['pct_correct_dogs']}\n"
